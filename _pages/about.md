...
profile:
  ...
  more_info: >
    ...
    <p>Beijing, China</p>
    <p>Email: <a href="mailto:xuedunyao1202@ruc.edu.cn">xuedunyao1202@ruc.edu.cn</a></p>
...
Welcome to my page! I am Dunyao Xue, a PhD student in Statistics at the [Institute of Statistics and Big Data](http://isbd.ruc.edu.cn/), Renmin University of China, advised by [Dr. Cheng Meng](https://cheng-bdal.github.io/) and [Dr. Wenlin Dai](https://sites.google.com/view/wenlindai/).
...
<div class="home-research-map" aria-label="Research map">
  ...
  <div>
    ...
    <span>invariant metrics, cross-space comparison, structured distributions</span>
  </div>
  <div>
    <strong>Efficient LLMs</strong>
    <span>MoE routing, ensemble pruning, geometry-aware decoding</span>
  </div>
</div>
